...
const TaggedTemplateLiteral = () =>
  <SectionLayout
    sub
    title={<Code>TaggedTemplateLiteral</Code>}
    labels={['web', 'native']}
  >
    <p>
      {
    ...
    <p>
      ...
      <Link inline href="/docs/basics#adapting-based-on-props">
    ...
    <p>
      The properties that are passed into an interpolated function get attached
      a special property, <Code>theme</Code>, which is injected by a higher
      level <Code>ThemeProvider</Code> component.
    ...
    <p>
      You can also return objects from interpolations or input objects directly,
      and they'll be treated as inline styles. However this is highly
      discouraged, as the CSS syntax has support for pseudo selectors, media
      queries, nesting, etc., which the object syntax doesn't.
    </p>
  </SectionLayout>;
